 ...
 */
public class McGovernChristian22 {
// data fields
 ...
 */
   ...
   // Instantiate menu & display menu
      McGovernChristian22 menu = new McGovernChristian22();
      menu.displayMenu();
   }
 ...
 */
   public void nodeInformation(T searchKey) {
      ...
      if (getParent(searchKey) == null){
        System.out.println("parent = no parent");
      }
      
      else{
           System.out.println("parent = " + getParent(searchKey));
          }
          
      System.out.println("left child = " + getLeft(searchKey));
      System.out.println("right child = " + getRight(searchKey)); 
      System.out.println(" ");
